...
public class TaskAdaptor extends RecyclerView.Adapter<TaskAdaptor.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        switch (task.getPriority()) {
            case 0:
                color = holder.itemView.getResources().getColor(R.color.priority0);
                break;
            case 1:
                color = holder.itemView.getResources().getColor(R.color.priority1);
                break;
            case 2:
                color = holder.itemView.getResources().getColor(R.color.priority2);
                break;
        }
